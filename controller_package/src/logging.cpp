...
void LoggingClass::data_logger(Eigen::Vector6d tau, Eigen::Vector6d z, Eigen::Quaterniond q, Eigen::Quaterniond q_d, 
    ...
    header[27] = "V";
    header[30] = "Axes";
    const std::string Coeffs[38] = {"Time", "T1", "T2", "T3", "T4", "T5", "T6", "Z1", "Z2", "Z3", "Z4", "Z5", "Z6", 
                                   "Q1", "Q2", "Q3", "Q4", "Q_D1", "Q_D2", "Q_D3", "Q_D4", 
                                   "X1", "X2", "X3", "X_D1", "X_D2", "X_D3", "V1", "V2", "V3", "A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8"
                                   };
    while (i < 38){
        outfile << header[i] << ", ";
        i++;
    ...
    i = 0;
    while(i < 3)                                                                     //Logging velocity parameters to file
    {
        outfile << v(i) << ", ";
        i++;
    }
